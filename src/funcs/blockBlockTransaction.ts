 ...
 */
export function blockBlockTransaction(
  client: IcpmcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.BlockTransactionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/block/transaction")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BlockTransactionResponse$inboundSchema),
