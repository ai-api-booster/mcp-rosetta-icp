 ...
 */
export function accountAccountCoins(
  client: IcpmcpCore,
  request: models.AccountCoinsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.AccountCoinsResponse,
    | errors.ErrorT
    | IcpmcpError
...
> {
  const parsed = safeParse(
    request,
    (value) => models.AccountCoinsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/account/coins")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AccountCoinsResponse$inboundSchema),
