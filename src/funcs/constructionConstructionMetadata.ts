 ...
 */
export function constructionConstructionMetadata(
  client: IcpmcpCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.ConstructionMetadataRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/construction/metadata")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ConstructionMetadataResponse$inboundSchema),
